...
![alt text](images/lab07/img.7.pytest.png)

<h2>Black.<h2>

![alt text](images/lab07/img.7.black..png)
...
```
![alt text](images/lab06/img.6.1.png)

![alt text](images/lab06/img.6.2.png)
...
```
```
python -m src.lab06.cli2 csv2xlsx --in "src/lab05/samples/example2.csv" --out "src/lab06/out/example2_csv.xlsx"
```
![alt text](<images/lab06/img.6.2.2— копия.png>)

```
python -m src.lab06.cli2 csv2json --in "src/lab05/samples/example2.csv" --out "src/lab06/out/example2_csv.json" 
```
![alt text](images/lab06/img.6.2.1.png)

```
python -m src.lab06.cli2 json2csv --in "src/lab05/samples/example1.json" --out "src/lab06/out/example1.csv"  
```
![alt text](images/lab06/img.6.2.3.png)
